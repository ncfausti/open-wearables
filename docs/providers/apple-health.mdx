...
Apple Health integration uses a **push-based model** where health data is sent from the user's device to Oriya using our mobile SDK. This is different from cloud providers like Garmin or Polar that use webhooks.
