...
The Oriya React Native SDK (`open-wearables-react-native-sdk`) enables secure background synchronization of health data from **Apple HealthKit** (iOS), **Samsung Health**, and **Health Connect** (Android) to the Oriya platform.
