...
Oriya Sync SDKs enable seamless background synchronization of health data directly from **Apple HealthKit** (iOS), **Samsung Health**, and **Health Connect** (Android) to the Oriya platform.
...
<Steps>
  ...
  <Step title="Oriya" icon="cloud-arrow-up">
...
<CardGroup cols={2}>
  ...
  <Card title="Wide Data Support" icon="chart-line">
    Steps, heart rate, workouts, sleep, body measurements, nutrition, and more — all normalized to Oriya data model.
  </Card>
</CardGroup>
