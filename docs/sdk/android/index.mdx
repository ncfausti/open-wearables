...
The Oriya Android SDK (`open-wearables-android-sdk`) is a native Kotlin SDK for secure background synchronization of health data from **Samsung Health** and **Health Connect** to the Oriya platform.
