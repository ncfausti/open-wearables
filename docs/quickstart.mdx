---
title: "Quickstart"
description: "Get Oriya up and running in minutes"
---

## Get started in three steps

Get Oriya running locally and start integrating wearable device data.

### Step 1: Set up your environment

<AccordionGroup>
  <Accordion icon="copy" title="Clone the repository">
    Clone the Oriya repository to your local machine:
