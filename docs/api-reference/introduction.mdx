---
title: 'API Reference'
description: 'Complete API documentation for Oriya'
---
...
The Oriya API provides a unified REST interface to access health data from multiple wearable devices and fitness platforms. All endpoints are versioned under `/api/v1` and follow RESTful conventions.
...
1. Access the Oriya Platform at `http://localhost:3000`
2. Log in
