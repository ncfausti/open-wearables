...
The presented unified data model is a first iteration of the underlying Oriya data structure - we fully intend to expand upon it, and introduce new features. Some of the planned stages of development are as follows:
1. **Base model architecture (starting point)** - The base data model discussed above, provided with the first release of the Oriya platform
