...
This roadmap outlines what's currently available in Oriya and what's coming next. Our goal is to build a comprehensive platform that simplifies wearable data integration and enables AI-powered health insights.

<Note>
**Have questions?** Join our [Discord community](https://discord.gg/qrcfFnNE6H) to get help, ask questions, and connect with other developers building with Oriya.
</Note>
...
The developer portal provides a web-based interface for managing your Oriya integration. It includes:
...
<Tip>Imagine a scenario where you're building an application for personal trainers. Thanks to Oriya and MCP integration, you'll be able to easily implement a chat through which the trainer will be able to query in natural language about the latest data from their athletes' wearables.</Tip>
...
- **Seamless User Registration and Data Sync**: Streamlined onboarding process that automatically creates users in Oriya and syncs their health data
...
- **Seamless User Registration and Data Sync**: Streamlined onboarding that automatically creates users in Oriya and syncs their health data
- **Background Sync**: Automatic data synchronization in the background
...
An embeddable widget that allows users to connect their wearables directly from your application, without being redirected to the Oriya UI.
...
Platform-generated health scores that provide unified, provider-independent interpretations of health data. Instead of relying on manufacturer-specific (often black-box) scores, Oriya will calculate its own default scores based on raw data.
