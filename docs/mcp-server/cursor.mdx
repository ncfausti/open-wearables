...
title: "Cursor"
sidebarTitle: "Cursor"
description: "Configure the Oriya MCP server with Cursor IDE"
---
...
If configured correctly, the AI will use the `get_users` tool to fetch available users from your Oriya instance.
